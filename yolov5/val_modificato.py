...
from models.common_modificato import DetectMultiBackend
...
def run(
    ...
    if training:  # called by train.py
        ...
        # Load model
        model = DetectMultiBackend(weights, device=device, dnn=dnn, data=data, fp16=half, float_type=float_type)
    ...
    # Print results
    pf = '%20s' + '%11i' * 2 + '%11.6g' * 4  # print format
...
def parse_opt():
    ...
    parser.add_argument('--float_type', type=str, default='posit160', help='numeric type') #NEW
